...
from LD.models.archs import define_network
from LD.models.base_model import BaseModel
from LD.utils import get_root_logger, imwrite, tensor2img

loss_module = importlib.import_module('LD.models.losses')
metric_module = importlib.import_module('LD.metrics')
from LD.models.archs.encoder1 import ConvEncoderLoss
...
class ImageRestorationModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_loss.load_state_dict(torch.load("./checkpoints/basicsr/net_E.pth"), strict=False)
