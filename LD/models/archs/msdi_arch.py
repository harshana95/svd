...
from LD.models.archs.architecture1 import SPADEResnetBlock1 as SPADEResnetBlock
from LD.models.archs.encoder1 import ConvEncoder
...
class msdi_net(nn.Module):
    ...
    def __init__(self, in_chn=3, wf=64, depth=5, relu_slope=0.2, hin_position_left=0, hin_position_right=4):
        ...
        self.prior_upsampling.load_state_dict(torch.load("./checkpoints/basicsr/prior_upsampling.pth"), strict=False)

        self.net_prior = ConvEncoder()
        self.net_prior.load_state_dict(torch.load("./checkpoints/basicsr/net_E.pth"), strict=False)
