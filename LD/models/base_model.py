...
# from LD.models import lr_scheduler as lr_scheduler
from LD.utils.dist_util import master_only

logger = logging.getLogger('LDbasicsr')
...
class BaseModel():
    ...
    def get_current_log(self):
        return self.log_g_dict, self.log_d_dict
