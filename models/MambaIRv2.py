...
class MambaIRv2Config(PretrainedConfig):
    model_type = "MambaIRv2"
...
class MambaIRv2Model(PreTrainedModel):
    config_class = MambaIRv2Config
    ...
    def __init__(self, config):
        ...
        self.model = MambaIRv2(
                ...
                inner_rank=config.inner_rank,
                num_tokens=config.num_tokens,
                convffn_kernel_size=config.convffn_kernel_size,
                mlp_ratio=config.mlp_ratio,
                qkv_bias=config.qkv_bias,
                norm_layer=nn.LayerNorm if config.norm_layer=='nn.LayerNorm' else None,
                ape=config.ape,
...
if __name__ == '__main__':
    config = MambaIRv2Config()
    model = MambaIRv2Model(config).cuda()
    upscale = 4
    # model = MambaIRv2(
    #     upscale=2,
    #     img_size=128,
