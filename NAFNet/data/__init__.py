...
from NAFNet.data.prefetch_dataloader import PrefetchDataLoader
from NAFNet.utils import get_root_logger, scandir
...
_dataset_modules = [
    importlib.import_module(f'NAFNet.data.{file_name}')
