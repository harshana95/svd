...
def main(args):
    ...
    # ============================================================================================== 2. Load models
    if args.network.type == "MambaTM_noLPD":
        config = MambaTM_noLPDConfig(input_size=[args.datasets.train.resize, args.datasets.train.resize, args.network.steps], **args.network)
        model = MambaTM_noLPDModel(config)
