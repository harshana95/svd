...
from models.basicsr import MSDI2EModel, MultiscaleDiscriminatorModel, MSDI2EConfig
...
def main(args):
    ...
    # ============================================================================================== 2. Load models
    if args.network.type == "MSDI2E":
        config = MSDI2EConfig(depth=5)
        model = MSDI2EModel(config)
    ...
    model,discriminator, optimizer, dataloader, test_dataloader, lr_scheduler = accelerator.prepare(
        model, discriminator, optimizer, dataloader, test_dataloader, lr_scheduler
    )
